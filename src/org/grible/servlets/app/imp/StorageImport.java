	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		try {
			...
			if (Dao.isTableInProductExist(storageName, TableType.STORAGE, categoryId)) {
				...
				String destination = "/grible/storages/?id=" + table.getId();
				...
				String destination = "";
				if (storageId > 0) {
					destination = "/grible/storages/?id=" + storageId;
				} else {
					int productId = Integer.parseInt(request.getParameter("product"));
					destination = "/grible/storages/?product=" + productId;
				}
			...
			int productId = Integer.parseInt(request.getParameter("product"));
			String destination = "/grible/storages/?product=" + productId;
