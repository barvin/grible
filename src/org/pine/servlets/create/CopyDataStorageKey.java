 ...
 */
@WebServlet("/CopyDataStorageKey")
public class CopyDataStorageKey extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CopyDataStorageKey() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		List<DataStorageValue> values = sqlHelper.getDataStorageValues(currentKey);
		sqlHelper.insertDataStorageValuesWithKeyId(newKeyId, values);
