 ...
 */
@WebServlet("/GetPreconditions")
public class GetPreconditions extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		List<PreconditionValue> prValues = sqlHelper.getPreconditionValues(dataFileId);
	...
	private void writeKeys(PrintWriter out, List<PreconditionValue> values) {
		out.print("<div class=\"table-row key-row\">");
		for (PreconditionValue value : values) {
			out.print("<div id=\"" + value.getId() + "\" class=\"table-cell key-cell ui-cell\">" + value.getKey()
					+ "</div>");
		}
		out.println("</div>");
	}

	private void writeValues(PrintWriter out, List<PreconditionValue> values) {
